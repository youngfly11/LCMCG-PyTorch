...
class Conv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, relu=True, same_padding=False, bn=False, dilation=1):
...
class StackConv(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, conv_num=3, skip_conn=True):
