...
_C.MODEL.VG.VOCAB_FILE = "datasets/skip-thoughts/vocab.json"
_C.MODEL.VG.SKIP_THROUGH_DATA_DIR = "datasets/skip-thoughts"
_C.MODEL.VG.DETECTION_VOCAB_FILE = 'datasets/flickr30k_anno/object_vocab_genome.json'
...
_C.MODEL.RELATION.RELATION_FEATURES = False
