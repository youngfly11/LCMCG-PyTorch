...
@C2_FORMAT_LOADER.register("Bottom-Up-R-101-C4")
@C2_FORMAT_LOADER.register("Bottom-Up-R-101-C4-FPN")
@C2_FORMAT_LOADER.register("Bottom-Up-R-101-C3")
@C2_FORMAT_LOADER.register("Bottom-Up-R-101-C4-Top")
def load_resnet_c2_format(cfg, f):
    state_dict = _load_c2_pickled_weights(f)
    conv_body = cfg.MODEL.BACKBONE.CONV_BODY
    arch = conv_body.replace("-C4", "").replace("-C5", "").replace("-FPN", "")
